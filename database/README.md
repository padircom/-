...
> از ۲۲۳ جدولِ ارجاع‌شده در فریم‌ورک را می‌سازد. هر دو idempotent هستند و
...
| فایل | کاربرد |
|---|---|
| `schema-mssql.sql` | شِمای SQL Server — ۲۲۳ جدول (مکملِ `db/mssql/`) |
...
> **دربارهٔ ستونِ Payload**: فریم‌ورک به ۲۲۳ جدول ارجاع می‌دهد و تنها بخشی از ستون‌ها از کد
