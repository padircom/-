...
**اصل:** حفظ ساختار · افزودن قابلیت · Excel ظرف است نه منبع حقیقت · (الحاقیه ۱۸ شهریور ۱۴۰۵: به درخواست کارفرما HSE با شناسه d8 به سایدبار اصلی — بالای «مدیریت سامانه» — اضافه شد و قید «بدون آیتم سایدبار» لغو گردید)
